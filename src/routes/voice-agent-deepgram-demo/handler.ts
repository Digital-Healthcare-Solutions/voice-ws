    ...
    await connection.configure({
      ...
      agent: {
        ...
        think: {
          ...
          model: "gpt-4o-mini",
          instructions:
            "Your name is Ava. You are a helpful AI assistant assisting patients over the phone. ",
          functions: [
            {
              name: "hang_up",
              ...
              parameters: {
                ...
                properties: {
                  ...
                  timeout: {
                    type: "number",
                    description:
                      "The amount of time to wait before hanging up (the timeout in seconds). Should be long enough for you to deliver the full message.",
                  },
                },
                // @ts-ignore
